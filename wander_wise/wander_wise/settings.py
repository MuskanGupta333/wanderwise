...
SECRET_KEY = 'django-insecure-7!dq@8^vp4bzzo%89gqnr5d!&f*2k+a^!nc3kpuvb-$54kdv0v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'Wander', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ os.path.join(BASE_DIR, 'Wander',  'static'),
]
